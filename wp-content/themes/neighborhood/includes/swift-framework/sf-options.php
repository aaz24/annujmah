...
//    );
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					...
    					array(
    						'id' => 'enable_mobile_account',
    						'type' => 'button_set',
    						'title' => __('Enable Mobile Account', "swiftframework"), 
    						'sub_desc' => __('If enabled, the menu dropdown will show account options.', "swiftframework"),
    						'desc' => '',
    						'options' => array('1' => 'On','0' => 'Off'),
    						'std' => '1'
    						),
